...
'''
@project : m3day32022
@file    : evaluate_fid_acc_inhard.py
@author  : payal
@contact : payalkaklotar006@gmail.com
@ide     : PyCharm
@time    : 2023-09-03 21:52
'''
...
class Evaluate_FID_ACC_InHARD():
    def __init__(self):
        super(Evaluate_FID_ACC_InHARD, self).__init__()

        self.cfg = ConfigDiverseSampling(exp_name="inhard_t2", device="cuda:0", num_works=0)
        print("\n================== Configs =================")

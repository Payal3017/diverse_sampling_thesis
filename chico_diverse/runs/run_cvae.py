...
from ..datas import MaoweiGSPS_Dynamic_Seq_Chico, MaoweiGSPS_Dynamic_Seq_Chico_ExtandDataset_T1, draw_multi_seqs_2d, get_dct_matrix, dct_transform_torch, reverse_dct_torch
...
class RunCVAE():
    def __init__(self, exp_name="chico_t1", device="cuda:0", num_works=0, is_debug=False, args=None):
        ...
        # # 数据
        self.train_data = MaoweiGSPS_Dynamic_Seq_Chico_ExtandDataset_T1(data_path=self.cfg.base_data_dir,
    ...
    def train(self, epoch, draw=False):
        ...
        for i, datas in enumerate(dg):
            ...
            angle_err = loss_valid_angle_t1(outputs[:, :, self.cfg.t_his:], self.valid_angle, data="chico")

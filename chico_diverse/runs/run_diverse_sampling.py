...
from ..datas import MaoweiGSPS_Dynamic_Seq_Chico, draw_multi_seqs_2d, get_dct_matrix, dct_transform_torch, reverse_dct_torch
...
class RunDiverseSampling():
    def __init__(self, exp_name="", device="cuda:0", num_works=0, is_debug=False, args=None):
        ...
        # 数据
        self.train_data = MaoweiGSPS_Dynamic_Seq_Chico(data_path=self.cfg.base_data_dir,

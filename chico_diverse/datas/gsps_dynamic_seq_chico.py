...
class MaoweiGSPS_Dynamic_Seq_Chico():
...
class MaoweiGSPS_Dynamic_Seq_Chico_ExtandDataset_T1():
...
if __name__ == '__main__':
    ...
    test_d = MaoweiGSPS_Dynamic_Seq_Chico(mode="test", similar_cnt=0, is_debug=True)
